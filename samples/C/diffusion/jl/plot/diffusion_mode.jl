    ...
    for fig in [compare_max, compare_med]
        ...
        for ii in 1:fig.nx
            for jj in 1:fig.ny
                ...
                at = fig.ax[ii, jj]
                at.text(0.02, 0.97, string(caption, "~", maptag), color="black", fontsize=fig.fs * 0.8, horizontalalignment="left", verticalalignment="top", transform=at.transAxes, bbox=Dict("facecolor" => "white", "edgecolor" => "None", "alpha" => 0.75))
            end
            # for ii in 3:4
            #     for jj in 3:4
