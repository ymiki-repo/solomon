...
/// @brief benchmark of direct N-body simulation (w/o orbit integration) (implementation in generic style)
///
...
int main(void) {
  ...
  // measure performance
  static char filename[64];
  sprintf(filename, "log/nbody_benchmark_%s%d.csv", COMPILER, MODEL_ID);
  FILE *fp;
