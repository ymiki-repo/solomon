...
///
#define PRAGMA_OMP_SCAN(...) PRAGMA_OMP(scan SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_SCAN), __VA_ARGS__))
...
///
#define PRAGMA_OMP_DECLARE_SIMD(...) PRAGMA_OMP(declare simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DECLARE_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TILE(...) PRAGMA_OMP(tile SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TILE), __VA_ARGS__))

///
/// @brief _Pragma("omp unroll [clause [[,] clause] ... ]")
/// @details Fully or partially unrolls a loop.
///
#define PRAGMA_OMP_UNROLL(...) PRAGMA_OMP(unroll SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_UNROLL), __VA_ARGS__))
...
///
#define PRAGMA_OMP_PARALLEL(...) PRAGMA_OMP(parallel SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN), __VA_ARGS__))
///
/// @brief finalize the omp parallel region
///
...
///
#define PRAGMA_OMP_TEAMS(...) PRAGMA_OMP(teams SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS), __VA_ARGS__))
///
/// @brief finalize the omp teams region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_SIMD(...) PRAGMA_OMP(simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief finalize the omp simd region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_MASKED(...) PRAGMA_OMP(masked SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_MASKED), __VA_ARGS__))
...
///
#define PRAGMA_OMP_SINGLE(...) PRAGMA_OMP(single SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_SINGLE), __VA_ARGS__))
///
/// @brief finalize the omp single region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_WORKSHARE(...) PRAGMA_OMP(workshare SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_WORKSHARE), __VA_ARGS__))
...
///
#define PRAGMA_OMP_SCOPE(...) PRAGMA_OMP(scope SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_SCOPE), __VA_ARGS__))
...
///
#define PRAGMA_OMP_SECTIONS(...) PRAGMA_OMP(sections SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_SECTIONS), __VA_ARGS__))
///
/// @brief finalize the omp sections region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_FOR(...) PRAGMA_OMP(for SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp for [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team.
///
#define PRAGMA_OMP_DO(...) PRAGMA_OMP_FOR(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
/// @brief _Pragma("omp do [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team.
///
#define PRAGMA_OMP_DO(...) PRAGMA_OMP(do SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp do [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team.
///
#define PRAGMA_OMP_FOR(...) PRAGMA_OMP_DO(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_DISTRIBUTE(...) PRAGMA_OMP(distribute SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE), __VA_ARGS__))
...
///
#define PRAGMA_OMP_LOOP(...) PRAGMA_OMP(loop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_LOOP), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TASK(...) PRAGMA_OMP(task SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TASK), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TASKLOOP(...) PRAGMA_OMP(taskloop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TASKLOOP), __VA_ARGS__))
...
///
#define PRAGMA_OMP_INTEROP(...) PRAGMA_OMP(interop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_INTEROP), __VA_ARGS__))
...
///
#define PRAGMA_OMP_CRITICAL(...) PRAGMA_OMP(critical SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_CRITICAL), __VA_ARGS__))
///
/// @brief finalize the omp critical region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_TASKGROUP(...) PRAGMA_OMP(taskgroup SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TASKGROUP), __VA_ARGS__))

///
/// @brief _Pragma("omp taskwait [clause [[,] clause] ... ]")
/// @details Specifies a wait on the completion of child tasks of the current task.
///
#define PRAGMA_OMP_TASKWAIT(...) PRAGMA_OMP(taskwait SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TASKWAIT), __VA_ARGS__))
...
///
#define PRAGMA_OMP_FLUSH(...) PRAGMA_OMP(flush SOLOMON_INTERNAL_APPEND_CLAUSES_WITHOUT_SORTING(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_FLUSH), OMP_PASS_LIST(__VA_ARGS__)))
...
///
#define PRAGMA_OMP_DEPOBJ(...) PRAGMA_OMP(depobj SOLOMON_INTERNAL_APPEND_CLAUSES_WITHOUT_SORTING(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DEPOBJ), OMP_PASS_LIST(__VA_ARGS__)))

///
/// @brief _Pragma("omp atomic [clause [[,] clause] ... ]")
/// @details Ensures a specific storage location is accessed atomically.
///
#define PRAGMA_OMP_ATOMIC(...) PRAGMA_OMP(atomic SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_ATOMIC), __VA_ARGS__))
...
///
#define PRAGMA_OMP_ORDERED(...) PRAGMA_OMP(ordered SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_ORDERED), __VA_ARGS__))
...
// ///
// #define PRAGMA_OMP_CANCEL(...) PRAGMA_OMP(cancel SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_CANCEL), __VA_ARGS__))
...
// ///
// #define PRAGMA_OMP_CANCELLATION_POINT(...) PRAGMA_OMP(cancellation point SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_CANCELLATION_POINT), __VA_ARGS__))
...
///
#define PRAGMA_OMP_FOR_SIMD(...) PRAGMA_OMP(for simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_NOWAIT, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp for simd [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team and the iterations executed by each thread can also be executed concurrently using SIMD instructions.
/// @note clause: Any of the clauses accepted by the simd or for directives.
///
#define PRAGMA_OMP_DO_SIMD(...) PRAGMA_OMP_FOR_SIMD(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
/// @brief _Pragma("omp do simd [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team and the iterations executed by each thread can also be executed concurrently using SIMD instructions.
/// @note clause: Any of the clauses accepted by the simd or do directives.
///
#define PRAGMA_OMP_DO_SIMD(...) PRAGMA_OMP(do simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_NOWAIT, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp do simd [clause [[,] clause] ... ]")
/// @details Specifies that the iterations of associated loops will be executed in parallel by threads in the team and the iterations executed by each thread can also be executed concurrently using SIMD instructions.
/// @note clause: Any of the clauses accepted by the simd or do directives.
///
#define PRAGMA_OMP_FOR_SIMD(...) PRAGMA_OMP_DO_SIMD(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_DISTRIBUTE_SIMD(...) PRAGMA_OMP(distribute simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR(...) PRAGMA_OMP(distribute parallel for SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp distribute parallel for [clause [[,] clause] ... ]")
/// @details Specify a loop that can be executed in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel for.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO(...) PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
/// @brief _Pragma("omp distribute parallel do [clause [[,] clause] ... ]")
/// @details Specify a loop that can be executed in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel do.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO(...) PRAGMA_OMP(distribute parallel do SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp distribute parallel do [clause [[,] clause] ... ]")
/// @details Specify a loop that can be executed in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel do.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR(...) PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)

#if !defined(SOLOMON_FORTRAN)
///
/// @brief _Pragma("omp distribute parallel for simd [clause [[,] clause] ... ]")
...
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR_SIMD(...) PRAGMA_OMP(distribute parallel for simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp distribute parallel for simd [clause [[,] clause] ... ]")
/// @details Specifies a loop that can be executed concurrently using SIMD instructions in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel for simd.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO_SIMD(...) PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR_SIMD(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
/// @brief _Pragma("omp distribute parallel do simd [clause [[,] clause] ... ]")
/// @details Specifies a loop that can be executed concurrently using SIMD instructions in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel do simd.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO_SIMD(...) PRAGMA_OMP(distribute parallel do simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp distribute parallel do simd [clause [[,] clause] ... ]")
/// @details Specifies a loop that can be executed concurrently using SIMD instructions in parallel by multiple threads that are members of multiple teams.
/// @note clause: Any clause used for distribute or parallel do simd.
///
#define PRAGMA_OMP_DISTRIBUTE_PARALLEL_FOR_SIMD(...) PRAGMA_OMP_DISTRIBUTE_PARALLEL_DO_SIMD(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_TASKLOOP_SIMD(...) PRAGMA_OMP(taskloop simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TASKLOOP, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_PARALLEL_FOR(...) PRAGMA_OMP(parallel for SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp parallel for [clause [[,] clause] ... ]")
/// @details Specifies a parallel construct containing a worksharing-loop construct with a canonical loop nest and no other statements.
/// @note clause: Any clause used for parallel or for except the nowait clause.
///
#define PRAGMA_OMP_PARALLEL_DO(...) PRAGMA_OMP_PARALLEL_FOR(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
...
///
#define PRAGMA_OMP_PARALLEL_DO(...) PRAGMA_OMP(parallel do SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp parallel do [clause [[,] clause] ... ]")
/// @details Specifies a parallel construct containing a worksharing-loop construct with a canonical loop nest and no other statements.
/// @note clause: Any clause used for parallel or do except the nowait clause.
///
#define PRAGMA_OMP_PARALLEL_FOR(...) PRAGMA_OMP_PARALLEL_DO(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_PARALLEL_LOOP(...) PRAGMA_OMP(parallel loop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_LOOP), __VA_ARGS__))
...
///
#define PRAGMA_OMP_PARALLEL_SECTIONS(...) PRAGMA_OMP(parallel sections SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_SECTIONS), __VA_ARGS__))
///
/// @brief finalize the omp parallel sections region
///
#if !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_PARALLEL_FOR_SIMD(...) PRAGMA_OMP(parallel for simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp parallel for simd [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a parallel construct containing only one worksharing-loop SIMD construct.
/// @note clause: Any clause used for parallel or for simd except the nowait clause.
///
#define PRAGMA_OMP_PARALLEL_DO_SIMD(...) PRAGMA_OMP_PARALLEL_FOR_SIMD(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
...
///
#define PRAGMA_OMP_PARALLEL_DO_SIMD(...) PRAGMA_OMP(parallel do simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp parallel do simd [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a parallel construct containing only one worksharing-loop SIMD construct.
/// @note clause: Any clause used for parallel or do simd except the nowait clause.
///
#define PRAGMA_OMP_PARALLEL_FOR_SIMD(...) PRAGMA_OMP_PARALLEL_DO_SIMD(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_MASKED_TASKLOOP(...) PRAGMA_OMP(masked taskloop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_MASKED, SOLOMON_INTERNAL_TAG_OMP_TASKLOOP, SOLOMON_INTERNAL_TAG_OMP_IN_REDUCTION), __VA_ARGS__))
...
///
#define PRAGMA_OMP_MASKED_TASKLOOP_SIMD(...) PRAGMA_OMP(masked taskloop simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_MASKED, SOLOMON_INTERNAL_TAG_OMP_TASKLOOP, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_PARALLEL_MASKED_TASKLOOP(...) PRAGMA_OMP(parallel masked taskloop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_MASKED, SOLOMON_INTERNAL_TAG_OMP_TASKLOOP), __VA_ARGS__))
...
///
#define PRAGMA_OMP_PARALLEL_MASKED_TASKLOOP_SIMD(...) PRAGMA_OMP(parallel masked taskloop simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_MASKED, SOLOMON_INTERNAL_TAG_OMP_TASKLOOP, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE(...) PRAGMA_OMP(teams distribute SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_SIMD(...) PRAGMA_OMP(teams distribute simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR(...) PRAGMA_OMP(teams distribute parallel for SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp teams distribute parallel for [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a teams construct containing a distribute parallel worksharing-loop construct and no other statements.
/// @note clause: Any clause used for teams or distribute parallel for.
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO(...) PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO(...) PRAGMA_OMP(teams distribute parallel do SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR), __VA_ARGS__))
///
/// @brief _Pragma("omp teams distribute parallel do [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a teams construct containing a distribute parallel worksharing-loop construct and no other statements.
/// @note clause: Any clause used for teams or distribute parallel do.
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR(...) PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR_SIMD(...) PRAGMA_OMP(teams distribute parallel for simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp teams distribute parallel for simd [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a teams construct containing a distribute parallel for simd construct and no other statements.
/// @note clause: Any clause used for teams or distribute parallel for simd.
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO_SIMD(...) PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR_SIMD(__VA_ARGS__)
#else  // !defined(SOLOMON_FORTRAN)
///
...
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO_SIMD(...) PRAGMA_OMP(teams distribute parallel do simd SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_DISTRIBUTE, SOLOMON_INTERNAL_TAG_OMP_PARALLEL, SOLOMON_INTERNAL_TAG_OMP_COPYIN, SOLOMON_INTERNAL_TAG_OMP_FOR, SOLOMON_INTERNAL_TAG_OMP_SIMD), __VA_ARGS__))
///
/// @brief _Pragma("omp teams distribute parallel do simd [clause [[,] clause] ... ]")
/// @details Shortcut for specifying a teams construct containing a distribute parallel do simd construct and no other statements.
/// @note clause: Any clause used for teams or distribute parallel do simd.
///
#define PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_FOR_SIMD(...) PRAGMA_OMP_TEAMS_DISTRIBUTE_PARALLEL_DO_SIMD(__VA_ARGS__)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_OMP_TEAMS_LOOP(...) PRAGMA_OMP(teams loop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_OMP_TEAMS, SOLOMON_INTERNAL_TAG_OMP_LOOP), __VA_ARGS__))
