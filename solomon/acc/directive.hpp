...
///
#define PRAGMA_ACC_PARALLEL(...) PRAGMA_ACC(parallel SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_PARALLEL), __VA_ARGS__))
///
...
#define PRAGMA_ACC_END_PARALLEL PRAGMA_ACC(end parallel)
...
///
#define PRAGMA_ACC_KERNELS(...) PRAGMA_ACC(kernels SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_KERNELS), __VA_ARGS__))
///
...
#else  // !defined(SOLOMON_FORTRAN)
#define PRAGMA_ACC_END_KERNELS PRAGMA_ACC(end kernels)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_ACC_SERIAL(...) PRAGMA_ACC(serial SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_SERIAL), __VA_ARGS__))
///
...
#else  // !defined(SOLOMON_FORTRAN)
#define PRAGMA_ACC_END_SERIAL PRAGMA_ACC(end serial)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_ACC_DATA(...) PRAGMA_ACC(data SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_DATA), __VA_ARGS__))
///
...
#else  // !defined(SOLOMON_FORTRAN)
#define PRAGMA_ACC_END_DATA PRAGMA_ACC(end data)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_ACC_ENTER_DATA(...) PRAGMA_ACC(enter data SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_ENTER_DATA), __VA_ARGS__))
...
///
#define PRAGMA_ACC_EXIT_DATA(...) PRAGMA_ACC(exit data SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_EXIT_DATA), __VA_ARGS__))
...
///
#define PRAGMA_ACC_HOST_DATA(...) PRAGMA_ACC(host_data SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_HOST_DATA), __VA_ARGS__))
///
...
#else  // !defined(SOLOMON_FORTRAN)
#define PRAGMA_ACC_END_HOST_DATA PRAGMA_ACC(end host_data)
#endif  // !defined(SOLOMON_FORTRAN)
...
///
#define PRAGMA_ACC_LOOP(...) PRAGMA_ACC(loop SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_LOOP), __VA_ARGS__))
...
///
#define PRAGMA_ACC_ATOMIC(...) PRAGMA_ACC(atomic SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_ATOMIC), __VA_ARGS__))
...
///
#define PRAGMA_ACC_UPDATE(...) PRAGMA_ACC(update SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_UPDATE), __VA_ARGS__))
...
///
#define PRAGMA_ACC_WAIT(...) PRAGMA_ACC(wait SOLOMON_INTERNAL_APPEND_CLAUSES_WITHOUT_SORTING(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_WAIT), ACC_PASS_LIST(__VA_ARGS__)))
...
///
#define PRAGMA_ACC_DECLARE(...) PRAGMA_ACC(declare SOLOMON_INTERNAL_APPEND_CLAUSES(SOLOMON_INTERNAL_ARGS_WITH_NUM(SOLOMON_INTERNAL_TAG_ACC_DECLARE), __VA_ARGS__))
